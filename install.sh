...
# @@Created          :  Sunday, Oct 09, 2022 15:39 EDT
# @@File             :  install.sh
# @@Description      :  Base alpine image
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/alpine"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="alpine"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/alpine"
APPDIR="$HOME/.local/share/srv/docker/alpine"
DATADIR="$HOME/.local/share/srv/docker/alpine/files"
...
HUB_IMAGE_URL="casjaysdevdocker/alpine"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
